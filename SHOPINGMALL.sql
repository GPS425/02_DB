...
CREATE TABLE PRODUCTS(
	...
	CATEGORY NUMBER CONSTRAINT FK_PRODUCTS_CATEGORY REFERENCES CATEGORIES(CATEGORY_ID),
...
CREATE TABLE ORDERS(
	...
	CUSTOMER_ID NUMBER CONSTRAINT FK_ORDERS_CUSTOMER REFERENCES CUSTOMERS(CUSTOMER_ID)
	ON DELETE CASCADE
);
...
CREATE TABLE ORDER_DETAILS(
	...
	ORDER_ID NUMBER CONSTRAINT FK_DETAILS_ORDERS REFERENCES ORDERS(ORDER_ID)
	ON DELETE CASCADE,
	PRODUCT_ID NUMBER CONSTRAINT FK_DETAILS_PRODUCT REFERENCES PRODUCTS(PRODUCT_ID)
	ON DELETE SET NULL,
	QUANTITY NUMBER,
...
SELECT ORDER_ID, PRODUCT_NAME, QUANTITY, PRICE_PER_UNIT, (QUANTITY * PRICE_PER_UNIT) 주문별금액
FROM CUSTOMERS
